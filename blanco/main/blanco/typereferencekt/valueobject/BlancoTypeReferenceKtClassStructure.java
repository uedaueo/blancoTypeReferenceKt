package blanco.typereferencekt.valueobject;
 ...
 */
public class BlancoTypeReferenceKtClassStructure {
    /**
     * フィールド名を指定します。必須項目です。
     *
     * フィールド: [name]。
    ...
    public String toString() {
        ...
        buf.append("blanco.typereferencekt.valueobject.BlancoTypeReferenceKtClassStructure[");
     ...
     */
    public void copyTo(final BlancoTypeReferenceKtClassStructure target) {
        if (target == null) {
            throw new IllegalArgumentException("Bug: BlancoTypeReferenceKtClassStructure#copyTo(target): argument 'target' is null");
        }
