package blanco.typereferencekt.message;
...
/**
 * A resource bundle class used internally by the message definition [BlancoTypeReferenceKt].
 *
 * リソースバンドル定義: [BlancoTypeReferenceKtMessage]。<BR>
 * このクラスはリソースバンドル定義書から自動生成されたリソースバンドルクラスです。<BR>
 */
class BlancoTypeReferenceKtMessageResourceBundle {
    /**
     * リソースバンドルオブジェクト。
     *
    ...
    /**
     * BlancoTypeReferenceKtMessageResourceBundleクラスのコンストラクタ。
     *
     * 基底名[BlancoTypeReferenceKtMessage]、デフォルトのロケール、呼び出し側のクラスローダを使用して、リソースバンドルを取得します。
     */
    public BlancoTypeReferenceKtMessageResourceBundle() {
        try {
            fResourceBundle = ResourceBundle.getBundle("blanco/typereferencekt/message/BlancoTypeReferenceKtMessage");
     ...
     * BlancoTypeReferenceKtMessageResourceBundleクラスのコンストラクタ。
     *
     * 基底名[BlancoTypeReferenceKtMessage]、指定されたロケール、呼び出し側のクラスローダを使用して、リソースバンドルを取得します。
     *
     * @param locale ロケールの指定
     */
    public BlancoTypeReferenceKtMessageResourceBundle(final Locale locale) {
        try {
            fResourceBundle = ResourceBundle.getBundle("blanco/typereferencekt/message/BlancoTypeReferenceKtMessage", locale);
        } catch (MissingResourceException ex) {
        }
    }
     ...
     * BlancoTypeReferenceKtMessageResourceBundleクラスのコンストラクタ。
     *
     * 基底名[BlancoTypeReferenceKtMessage]、指定されたロケール、指定されたクラスローダを使用して、リソースバンドルを取得します。
     *
     * @param locale ロケールの指定
     * @param loader クラスローダの指定
     */
    public BlancoTypeReferenceKtMessageResourceBundle(final Locale locale, final ClassLoader loader) {
        try {
            fResourceBundle = ResourceBundle.getBundle("blanco/typereferencekt/message/BlancoTypeReferenceKtMessage", locale, loader);
        } catch (MissingResourceException ex) {
        }
    }
    ...
    /**
     * bundle[BlancoTypeReferenceKtMessage], key[MBVOJI01]
     *
    ...
    /**
     * bundle[BlancoTypeReferenceKtMessage], key[MBVOJI02]
     *
    ...
    /**
     * bundle[BlancoTypeReferenceKtMessage], key[MBVOJI03]
     *
    ...
    /**
     * bundle[BlancoTypeReferenceKtMessage], key[MBVOJI04]
     *
    ...
    /**
     * bundle[BlancoTypeReferenceKtMessage], key[MBVOJI05]
     *
    ...
    /**
     * bundle[BlancoTypeReferenceKtMessage], key[MBVOJI06]
     *
    ...
    /**
     * bundle[BlancoTypeReferenceKtMessage], key[MBVOJI07]
     *
    ...
    /**
     * bundle[BlancoTypeReferenceKtMessage], key[MBVOJI08]
     *
    ...
    /**
     * bundle[BlancoTypeReferenceKtMessage], key[MBVOJI09]
     *
    ...
    /**
     * bundle[BlancoTypeReferenceKtMessage], key[MBVOJI0A]
     *
    ...
    /**
     * bundle[BlancoTypeReferenceKtMessage], key[MBVOJA01]
     *
