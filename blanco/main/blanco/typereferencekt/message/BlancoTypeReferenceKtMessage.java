...
/**
 * blancoTypeReferenceKtが利用するメッセージ。
 */
public class BlancoTypeReferenceKtMessage {
    /**
     * A resource bundle class that is used internally to make messages correspond to property files.
     */
    protected final BlancoTypeReferenceKtMessageResourceBundle fBundle = new BlancoTypeReferenceKtMessageResourceBundle();

    /**
     * Gets the string of message definition ID [BlancoTypeReferenceKt] and key [MBVOJI01].
     *
     * No.2:
    ...
    /**
     * Gets the string of message definition ID [BlancoTypeReferenceKt] and key [MBVOJI02].
     *
     * No.3:
    ...
    /**
     * Gets the string of message definition ID [BlancoTypeReferenceKt] and key [MBVOJI03].
     *
     * No.4:
    ...
    /**
     * Gets the string of message definition ID [BlancoTypeReferenceKt] and key [MBVOJI04].
     *
     * No.5:
    ...
    /**
     * Gets the string of message definition ID [BlancoTypeReferenceKt] and key [MBVOJI05].
     *
     * No.6:
    ...
    /**
     * Gets the string of message definition ID [BlancoTypeReferenceKt] and key [MBVOJI06].
     *
     * No.7:
    ...
    /**
     * Gets the string of message definition ID [BlancoTypeReferenceKt] and key [MBVOJI07].
     *
     * No.8:
    ...
    /**
     * Gets the string of message definition ID [BlancoTypeReferenceKt] and key [MBVOJI08].
     *
     * No.9:
    ...
    /**
     * Gets the string of message definition ID [BlancoTypeReferenceKt] and key [MBVOJI09].
     *
     * No.10:
    ...
    /**
     * Gets the string of message definition ID [BlancoTypeReferenceKt] and key [MBVOJI0A].
     *
     * No.11:
    ...
    /**
     * Gets the string of message definition ID [BlancoTypeReferenceKt] and key [MBVOJA01].
     *
     * No.11:
